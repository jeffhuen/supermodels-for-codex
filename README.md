...
![status](https://img.shields.io/badge/status-v0.2.7-blue) ![license](https://img.shields.io/badge/license-MIT-green) ![built for](https://img.shields.io/badge/built%20for-Codex-111827)
...
```bash
codex plugin marketplace add jeffhuen/supermodels-for-codex --ref v0.2.7
...
This is `v0.2.7` of a hobby project. It's well-tested and it works on my machine, but you should know the edges:
